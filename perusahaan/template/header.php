...
$id_pengguna = $_SESSION['pengguna']['id_perusahaan'];
$nama_pengguna = $_SESSION['pengguna']['nm_perusahaan'];
?>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item">
							<a class="nav-link" href="<?=base_url('perusahaan/index.php');?>">Beranda<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="<?=base_url('perusahaan/profil.php');?>">Profil</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="<?=base_url('perusahaan/buat-proyek.php');?>">Buat Proyek</a>
						</li>
					</ul>
