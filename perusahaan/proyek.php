...
if($page == '' || $page == 1 ){
	...
	// mengatur batar perhalaman berapa tabel ubah angka 5
	$page1 = ($page * 5) - 5;
}
...
// yang dibwah ini buat lagi percabangan untuk search dan pagination
// query menapilkan data dari tabel proyek, proposal, kategori
// $queryProyek = "SELECT id_proyek, judul_proyek,deskripsi, dana,nama_kategori,
// 				jlh_proposal, tgl_dibuat FROM proyek
// 				LEFT JOIN kategori USING(id_kategori)
// 				LEFT JOIN(
				...
				<div class="container">
					<div class="row my-4">
						...
						<div class="col-8">
							<div class="card">
								<div class="card-body">
									<h2 class="text-center text-primary">Data Tidak Ada</h2> 
								</div>
							</div>
						</div>
						<div class="col-2"></div>
