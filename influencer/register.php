...
<head>
	...
	<title> Daftar Influencer - InMark</title>
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper-register">
					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">Buat Akun Influencer Baru</h4>
							<?php
							if(isset($_POST['daftar'])){
								...
								$query_daftar = "SELECT * FROM influencer WHERE email = '$email'";
								...
								elseif(strlen($pass) < 8){
									...
									$pass = md5($pass);
									// insert the record
									$qdaftar_influencer = "INSERT INTO influencer (nm_lengkap, email, telp, password) VALUES ('$nama', '$email', '$telp', '$pass')";
									$sdaftar_influencer = mysqli_query($koneksi, $qdaftar_influencer) or die(mysqli_connect_error($koneksi));

									if($sdaftar_influencer != TRUE){
										echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
								...
								// mendapatkan id saatmendaftar
									$id_daftar_influencer = mysqli_insert_id($koneksi);
									// var_dump($id_daftar_influencer);
									$generateprofile_influencer = "INSERT INTO profil_influencer (id_influencer) VALUES ('$id_daftar_influencer')";
									// var_dump($generateprofile_influencer);
									$updateProfil = mysqli_query($koneksi, $generateprofile_influencer);
							...
							<form method="post">
								<div class="form-group">
									...
									<input type="text"  class="form-control" name="nama" placeholder="contoh : Fulan Pulan"  required autofocus />
								</div>
								<div class="form-group">
									<label>Alamat E-mail</label>
									<input type="email"  class="form-control" name="email"  placeholder="name@mail.com" required autofocus />
								</div>
								<div class="form-group">
								...
								<div class="form-group m-auto" style="width: 50%;">
									<button type="submit" name="daftar" class="btn btn-primary btn-block">Daftar Sebagai Influencer</button>
								</div>
							</form>
							<hr>
